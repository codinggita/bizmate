      ...
      case 0:
        switch (character2) {
          ...
          case 59:
            characters2 += ";";
          default:
            append2(reference2 = ruleset(characters2, root, parent, index2, offset2, rules, points, type, props = [], children = [], length2), rulesets);
            if (character2 === 123)
              if (offset2 === 0)
                ...
                switch (atrule === 99 && charat(characters2, 3) === 110 ? 100 : atrule) {
                  ...
                  case 109:
                  case 115:
                    parse(value, reference2, reference2, rule && append2(ruleset(value, reference2, reference2, 0, 0, rules, points, type, rules, props = [], length2), children), rules, children, length2, points, rule ? props : children);
                    break;
                  default:
...
function ruleset(value, root, parent, index2, offset2, rules, points, type, props, children, length2) {
  ...
  for (var i = 0, j = 0, k2 = 0; i < index2; ++i)
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs2(j = points[i])), z = value; x2 < size; ++x2)
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses13 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing: spacing2,
  ...
  const Grid2 = React29.forwardRef(function Grid3(inProps, ref) {
    ...
    const classes = useUtilityClasses13(ownerState, theme);
...
var SeriesContext = React33.createContext({});
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React33.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
  return (0, import_jsx_runtime14.jsx)(SeriesContext.Provider, {
...
function CartesianContextProvider(props) {
  ...
  const drawingArea = React37.useContext(DrawingContext);
  ...
  return (0, import_jsx_runtime16.jsx)(CartesianContext.Provider, {
    value,
    children
  });
}
true ? CartesianContextProvider.propTypes = {
  ...
  xAxis: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
    axisId: import_prop_types21.default.string,
...
var HighlighContext = React41.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React41.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  ...
  return (0, import_jsx_runtime19.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
...
var useInteractionItemProps = (scope) => {
  ...
  } = React42.useContext(HighlighContext);
...
var _excluded19 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
var AreaElementPath = styled_default2("path", {
  name: "MuiAreaElement",
  slot: "Root",
  ...
  stroke: "none",
  fill: ownerState.isHighlighted ? color2(ownerState.color).brighter(1).formatHex() : color2(ownerState.color).brighter(0.5).formatHex(),
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(Area, _extends({}, areaProps));
}
...
function useXScale(identifier2) {
  const {
    xAxis,
    xAxisIds
  } = React44.useContext(CartesianContext);
  const id = typeof identifier2 === "string" ? identifier2 : xAxisIds[identifier2 != null ? identifier2 : 0];
  return xAxis[id].scale;
}
function useYScale(identifier2) {
  const {
    yAxis,
    yAxisIds
  } = React44.useContext(CartesianContext);
  const id = typeof identifier2 === "string" ? identifier2 : yAxisIds[identifier2 != null ? identifier2 : 0];
  ...
  return (0, import_jsx_runtime21.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return !!series[seriesId].area && (0, import_jsx_runtime21.jsx)(AreaElement, {
          id: seriesId,
...
var _excluded21 = ["id", "classes", "color", "highlightScope", "slots", "slotProps"];
...
var LineElementPath = styled_default2("path", {
  name: "MuiLineElement",
  slot: "Root",
  overridesResolver: (_, styles) => styles.root
})(({
  ...
  fill: "none",
  stroke: ownerState.isHighlighted ? color2(ownerState.color).brighter(0.5).formatHex() : ownerState.color,
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(Line, _extends({}, lineProps));
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React48.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React49.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React49.createContext(init));
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React50.useContext(SVGContext);
  const {
    width: width2,
    height: height2,
    top: top3,
  ...
  const mousePosition = React50.useRef({
    x: -1,
    y: -1
  });
  React50.useEffect(() => {
...
var _excluded25 = ["children", "width", "height", "viewBox", "disableAxisListener", "className"];
var ChartChartsSurfaceStyles = styled_default2("svg", {
  name: "MuiChartsSurface",
  slot: "Root"
})(() => ({}));
var ChartsSurface = React51.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
  ...
  return (0, import_jsx_runtime25.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime24.jsx)("title", {
      children: props.title
    }), (0, import_jsx_runtime24.jsx)("desc", {
      children: props.desc
    }), children]
  }));
});
...
var ChartContainer = React52.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime26.jsx)(DrawingProvider, {
    width: width2,
    height: height2,
    margin: margin2,
    svgRef,
    children: (0, import_jsx_runtime26.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime26.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime26.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime26.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime26.jsx)(ChartsSurface, {
              width: width2,
              height: height2,
              ref: handleRef,
              sx,
...
var ResponsiveChartContainer = React53.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width2 && height2 ? (0, import_jsx_runtime27.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
var _excluded27 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope"];
...
MarkElementPath.propTypes = {
  ...
  ownerState: import_prop_types27.default.shape({
    ...
    x: import_prop_types27.default.number.isRequired,
    y: import_prop_types27.default.number.isRequired
  }).isRequired,
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(MarkElementPath, _extends({}, other, {
    ownerState,
    className: classes.root,
...
true ? MarkElement.propTypes = {
   ...
   */
  dataIndex: import_prop_types27.default.number.isRequired,
  highlightScope: import_prop_types27.default.shape({
    faded: import_prop_types27.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types27.default.oneOf(["item", "none", "series"])
  }),
  /**
...
function MarkPlot(props) {
  ...
  const seriesData = React55.useContext(SeriesContext).line;
    ...
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return xData == null ? void 0 : xData.map((x2, index2) => {
          ...
          return (0, import_jsx_runtime29.jsx)(Mark, _extends({
            id: seriesId,
            dataIndex: index2,
            shape: "circle",
            color: series[seriesId].color,
...
var _excluded29 = ["x", "y", "style", "text", "ownerState"];
...
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded29);
  ...
  return (0, import_jsx_runtime30.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime30.jsx)("tspan", {
      x: x2,
...
var _excluded30 = ["scale", "tickNumber"];
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React58.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded30);
  ...
  const {
    ...
    width: width2,
    height: height2
  } = React58.useContext(DrawingContext);
...
true ? ChartsXAxis.propTypes = {
   ...
   */
  axisId: import_prop_types30.default.string,
  /**
   * Override or extend the styles applied to the component.
   */
...
var _excluded31 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React59.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded31);
  ...
  return (0, import_jsx_runtime34.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime33.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime34.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime33.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && (0, import_jsx_runtime33.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
...
true ? ChartsYAxis.propTypes = {
   ...
   * If undefined, it will be the first defined axis.
   */
  axisId: import_prop_types31.default.string,
  /**
   * Override or extend the styles applied to the component.
   */
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    axisId: import_prop_types32.default.string,
   ...
   */
  leftAxis: import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    axisId: import_prop_types32.default.string,
    classes: import_prop_types32.default.object,
    disableLine: import_prop_types32.default.bool,
    disableTicks: import_prop_types32.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    axisId: import_prop_types32.default.string,
    classes: import_prop_types32.default.object,
    disableLine: import_prop_types32.default.bool,
    disableTicks: import_prop_types32.default.bool,
   ...
   * @default null
   */
  topAxis: import_prop_types32.default.oneOfType([import_prop_types32.default.shape({
    axisId: import_prop_types32.default.string,
    classes: import_prop_types32.default.object,
    disableLine: import_prop_types32.default.bool,
    disableTicks: import_prop_types32.default.bool,
...
var Portal = React61.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime37.jsx)(React61.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime37.jsx)(React61.Fragment, {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime40.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime40.jsx)("tbody", {
        children: (0, import_jsx_runtime41.jsxs)(ChartsTooltipRow, {
          ...
          children: [(0, import_jsx_runtime40.jsx)(ChartsTooltipCell, {
            ...
            children: (0, import_jsx_runtime40.jsx)(ChartsTooltipMark, {
              ownerState: {
                color: color3
              },
...
true ? DefaultChartsItemTooltipContent.propTypes = {
  ...
  itemData: import_prop_types36.default.shape({
    ...
    seriesId: import_prop_types36.default.string.isRequired,
    type: import_prop_types36.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types36.default.shape({
    color: import_prop_types36.default.string,
    data: import_prop_types36.default.oneOfType([import_prop_types36.default.arrayOf(import_prop_types36.default.number), import_prop_types36.default.arrayOf(import_prop_types36.default.number), import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
      ...
      x: import_prop_types36.default.number.isRequired,
      y: import_prop_types36.default.number.isRequired
    })), import_prop_types36.default.arrayOf(import_prop_types36.default.shape({
    ...
    type: import_prop_types36.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
    valueFormatter: import_prop_types36.default.func.isRequired
  }).isRequired,
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React66.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types37.default.shape({
    classes: import_prop_types37.default.object,
    itemData: import_prop_types37.default.shape({
      dataIndex: import_prop_types37.default.number,
      seriesId: import_prop_types37.default.string.isRequired,
      type: import_prop_types37.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types37.default.shape({
      color: import_prop_types37.default.string,
      data: import_prop_types37.default.oneOfType([import_prop_types37.default.arrayOf(import_prop_types37.default.number), import_prop_types37.default.arrayOf(import_prop_types37.default.number), import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
      ...
      })), import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
      ...
      id: import_prop_types37.default.string.isRequired,
      type: import_prop_types37.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired,
...
var _excluded33 = ["align", "className", "component", "gutterBottom", "noWrap", "paragraph", "variant", "variantMapping"];
...
var Typography = React67.forwardRef(function Typography2(inProps, ref) {
        ...
        children: series.map(({
          ...
          return (0, import_jsx_runtime45.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime44.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime44.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime44.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types39.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types39.default.shape({
    x: import_prop_types39.default.shape({
      index: import_prop_types39.default.number,
      value: import_prop_types39.default.oneOfType([import_prop_types39.default.instanceOf(Date), import_prop_types39.default.number]).isRequired
    }),
    y: import_prop_types39.default.shape({
      index: import_prop_types39.default.number,
      value: import_prop_types39.default.oneOfType([import_prop_types39.default.instanceOf(Date), import_prop_types39.default.number]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types39.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React69.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React69.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React69.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  axisData: import_prop_types40.default.shape({
    x: import_prop_types40.default.shape({
      ...
      value: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]).isRequired
    }),
  ...
  contentProps: import_prop_types40.default.shape({
    axis: import_prop_types40.default.object,
    axisData: import_prop_types40.default.shape({
      x: import_prop_types40.default.shape({
        index: import_prop_types40.default.number,
        value: import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]).isRequired
    ...
    axisValue: import_prop_types40.default.any,
    classes: import_prop_types40.default.object,
    dataIndex: import_prop_types40.default.number,
    series: import_prop_types40.default.arrayOf(import_prop_types40.default.object),
...
var _excluded34 = ["rotate", "dominantBaseline"];
...
function DefaultChartsLegend(props) {
  ...
  const theme = useTheme5();
  const labelStyle = React71.useMemo(
  ...
  const padding2 = React71.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React71.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded34);
  ...
  const seriesWithPosition = React71.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
true ? DefaultChartsLegend.propTypes = {
  ...
  series: import_prop_types42.default.shape({
    bar: import_prop_types42.default.shape({
      series: import_prop_types42.default.object.isRequired,
      seriesOrder: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
      stackingGroups: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
        ids: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
        stackingOffset: import_prop_types42.default.func.isRequired,
        stackingOrder: import_prop_types42.default.func.isRequired
      })).isRequired
    }),
    line: import_prop_types42.default.shape({
      series: import_prop_types42.default.object.isRequired,
      seriesOrder: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
      stackingGroups: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
        ids: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
    ...
    pie: import_prop_types42.default.shape({
      series: import_prop_types42.default.object.isRequired,
      seriesOrder: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired
    }),
    scatter: import_prop_types42.default.shape({
      series: import_prop_types42.default.object.isRequired,
      seriesOrder: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired
    })
  }).isRequired,
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React71.useContext(DrawingContext);
  const series = React71.useContext(SeriesContext);
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React72.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime51.jsxs)(React72.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime50.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime50.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime50.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime50.jsx)(ChartsAxisHighlightPath, {
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime53.jsx)(HighlightElement, _extends({}, other, {
    ownerState,
    className: classes.root,
    cx: 0,
    cy: 0,
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React75.useContext(SeriesContext).line;
  const axisData = React75.useContext(CartesianContext);
  const {
    axis
...
var LineChart = React76.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime56.jsxs)(ResponsiveChartContainer, {
    ...
    children: [(0, import_jsx_runtime56.jsxs)("g", {
...
true ? LineChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types47.default.oneOfType([import_prop_types47.default.shape({
    axisId: import_prop_types47.default.string,
   ...
   */
  disableLineItemHighlight: import_prop_types47.default.bool,
  /**
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types47.default.oneOfType([import_prop_types47.default.shape({
    axisId: import_prop_types47.default.string,
    classes: import_prop_types47.default.object,
    disableLine: import_prop_types47.default.bool,
    disableTicks: import_prop_types47.default.bool,
   ...
   * @default null
   */
  rightAxis: import_prop_types47.default.oneOfType([import_prop_types47.default.shape({
    axisId: import_prop_types47.default.string,
    classes: import_prop_types47.default.object,
    disableLine: import_prop_types47.default.bool,
    disableTicks: import_prop_types47.default.bool,
  ...
  series: import_prop_types47.default.arrayOf(import_prop_types47.default.shape({
    area: import_prop_types47.default.bool,
    color: import_prop_types47.default.string,
    connectNulls: import_prop_types47.default.bool,
    curve: import_prop_types47.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
    data: import_prop_types47.default.arrayOf(import_prop_types47.default.number),
    dataKey: import_prop_types47.default.string,
    disableHighlight: import_prop_types47.default.bool,
    highlightScope: import_prop_types47.default.shape({
      faded: import_prop_types47.default.oneOf(["global", "none", "series"]),
      highlighted: import_prop_types47.default.oneOf(["item", "none", "series"])
    }),
    id: import_prop_types47.default.string,
    label: import_prop_types47.default.string,
    showMark: import_prop_types47.default.oneOfType([import_prop_types47.default.func, import_prop_types47.default.bool]),
    stack: import_prop_types47.default.string,
    stackOffset: import_prop_types47.default.oneOf(["diverging", "expand", "none", "silhouette", "wiggle"]),
    stackOrder: import_prop_types47.default.oneOf(["appearance", "ascending", "descending", "insideOut", "none", "reverse"]),
    type: import_prop_types47.default.oneOf(["line"]),
    valueFormatter: import_prop_types47.default.func,
    xAxisKey: import_prop_types47.default.string,
    yAxisKey: import_prop_types47.default.string
  })).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   ...
   * @default null
   */
  topAxis: import_prop_types47.default.oneOfType([import_prop_types47.default.shape({
    axisId: import_prop_types47.default.string,
    classes: import_prop_types47.default.object,
    disableLine: import_prop_types47.default.bool,
    disableTicks: import_prop_types47.default.bool,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SMW5ECPI.js.map
